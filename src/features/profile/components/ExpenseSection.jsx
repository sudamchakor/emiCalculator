...
export default function ExpenseSection({
  ...
  const totalExpensesIncludingLoanAndGoals =
  ...
  return (
    <Grid container spacing={3}>
      {" "}
      {/* Added Grid container for responsiveness and spacing */}
      {!isModal && ( // Show Expense Details, list, total, and budget warning only if not in modal and not small screen
        <Grid item xs={12} md={6}>
          {" "}
          {/* Full width when not in modal */}
                  ...
                  <DatePicker
                    ...
                    slotProps={{
                      textField: {
                        size: "small",
                        fullWidth: true,
                        onClick: () => expenseStartYearOpen(true),
                      },
                    }}
                  ...
                  <DatePicker
                    ...
                    slotProps={{
                      textField: {
                        size: "small",
                        fullWidth: true,
                        onClick: () => setExpenseEndYearOpen(true),
                      },
                    }}
