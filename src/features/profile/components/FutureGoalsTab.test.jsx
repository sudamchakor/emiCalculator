...
import FutureGoalsTab from "./FutureGoalsTab";
...
jest.mock("./GoalForm", () => () => <div data-testid="goal-form" />);
...
describe("FutureGoalsTab Component", () => {
  ...
  it("renders goals when they exist in the store", () => {
    profileSlice.selectGoals.mockReturnValue([
      { id: 1, name: "Buy a House", targetAmount: 5000000, targetYear: 2030, category: "general" }
    ]);
  ...
  it("disables 'New Goal' button and shows warning if surplus is negative", () => {
    ...
    expect(screen.getByText(/Cannot add new goals. Your current surplus is negative./i)).toBeInTheDocument();
  });
});