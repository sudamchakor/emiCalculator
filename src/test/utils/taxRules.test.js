import {
  ...
  get80TTAExemption,
  get80TTBExemption,
  getSection24BExemption,
  getProfessionalTaxDeduction,
  getNewTaxRegimeSlabs,
  getOldTaxRegimeSlabs,
  getRebate87A,
  getTaxRegimeBenefits,
  getTaxRegimeComparison,
} from '../../src/utils/taxRules';

describe('Tax Rules Utility Functions', () => {
  ...
  describe('getStandardDeduction', () => {
    it('should return the standard deduction amount', () => {
      expect(getStandardDeduction()).toBe(MOCK_CONSTANTS.STANDARD_DEDUCTION);
    });
  });

  describe('getProfessionalTaxDeduction', () => {
    it('should return the professional tax paid up to the cap', () => {
      expect(getProfessionalTaxDeduction(2000)).toBe(2000);
      expect(getProfessionalTaxDeduction(3000)).toBe(MOCK_CONSTANTS.PROFESSIONAL_TAX_CAP);
    });
    it('should return 0 for negative professional tax', () => {
      expect(getProfessionalTaxDeduction(-1000)).toBe(0);
    });
  });
  ...
  describe('getHraExemption', () => {
    ...
    it('should calculate HRA exemption for metro city', () => {
      const exemption = getHraExemption(baseSalary, hraReceived, rentPaid, 'Yes');
      // Least of:
    ...
    it('should calculate HRA exemption for non-metro city', () => {
      const exemption = getHraExemption(baseSalary, hraReceived, rentPaid, 'No');
      // Least of:
      // 1. Actual HRA received: 200000
    ...
    it('should return 0 if HRA received is 0', () => {
      expect(getHraExemption(baseSalary, 0, rentPaid, 'Yes')).toBe(0);
    });

    it('should return 0 if rent paid is 0', () => {
      expect(getHraExemption(baseSalary, hraReceived, 0, 'Yes')).toBe(0);
    });
  });

  describe('get80CExemption', () => {
    it('should return the 80C amount up to the cap', () => {
      expect(get80CExemption(100000)).toBe(100000);
      expect(get80CExemption(200000)).toBe(MOCK_CONSTANTS.SECTION_80C_CAP);
    });
    it('should return 0 for negative 80C amount', () => {
      expect(get80CExemption(-50000)).toBe(0);
    });
  });

  describe('get80DExemption', () => {
    it('should calculate 80D for self/family below 60', () => {
      expect(get80DExemption(20000, 0, 0, 0, 0)).toBe(20000);
      expect(get80DExemption(30000, 0, 0, 0, 0)).toBe(MOCK_CONSTANTS.SECTION_80D_CAP_BELOW_60);
    });

    it('should calculate 80D for self/family above 60', () => {
      expect(get80DExemption(0, 30000, 0, 0, 0)).toBe(30000);
      expect(get80DExemption(0, 60000, 0, 0, 0)).toBe(MOCK_CONSTANTS.SECTION_80D_CAP_ABOVE_60);
    });

    it('should calculate 80D for parents below 60', () => {
      expect(get80DExemption(0, 0, 20000, 0, 0)).toBe(20000);
      expect(get80DExemption(0, 0, 30000, 0, 0)).toBe(MOCK_CONSTANTS.SECTION_80D_CAP_PARENT_BELOW_60);
    });

    it('should calculate 80D for parents above 60', () => {
      expect(get80DExemption(0, 0, 0, 30000, 0)).toBe(30000);
      expect(get80DExemption(0, 0, 0, 60000, 0)).toBe(MOCK_CONSTANTS.SECTION_80D_CAP_PARENT_ABOVE_60);
    });

    it('should include preventive health checkup up to 5000', () => {
      expect(get80DExemption(20000, 0, 0, 0, 5000)).toBe(25000);
      expect(get80DExemption(23000, 0, 0, 0, 5000)).toBe(MOCK_CONSTANTS.SECTION_80D_CAP_BELOW_60); // 23k + 5k = 28k, capped at 25k
      expect(get80DExemption(20000, 0, 0, 0, 6000)).toBe(25000); // 20k + 6k, capped at 25k (5k for checkup)
    });
    ...
    it('should sum up all applicable sections with caps', () => {
      ...
      expect(get80DExemption(selfFamilyBelow60, selfFamilyAbove60, parentsBelow60, parentsAbove60, preventiveCheckup)).toBe(45000);
      ...
      expect(get80DExemption(selfFamilyBelow60_cap, 0, 0, parentsAbove60_cap, 0)).toBe(75000);
    });
  });

  describe('get80EExemption', () => {
    it('should return the full interest paid on education loan', () => {
      expect(get80EExemption(50000)).toBe(50000);
      expect(get80EExemption(MOCK_CONSTANTS.SECTION_80E_MAX_INTEREST + 10000)).toBe(MOCK_CONSTANTS.SECTION_80E_MAX_INTEREST);
    });
    it('should return 0 for negative interest', () => {
      expect(get80EExemption(-10000)).toBe(0);
    });
  });

  describe('get80GExemption', () => {
    it('should return 100% donation without qualifying limit', () => {
      expect(get80GExemption(1000, 0, 0, 0)).toBe(1000);
    });

    it('should return 50% donation without qualifying limit', () => {
      expect(get80GExemption(0, 1000, 0, 0)).toBe(500);
    });
    ...
    it('should return 0 for negative donations', () => {
      expect(get80GExemption(-100, 0, 0, 0)).toBe(0);
    });
  });

  describe('get80TTAExemption', () => {
    it('should return interest on savings account up to cap', () => {
      expect(get80TTAExemption(5000, 50)).toBe(5000);
      expect(get80TTAExemption(12000, 50)).toBe(MOCK_CONSTANTS.SECTION_80TTA_CAP);
    });
    it('should return 0 for senior citizens', () => {
      expect(get80TTAExemption(5000, 65)).toBe(0);
    });
    it('should return 0 for negative interest', () => {
      expect(get80TTAExemption(-1000, 30)).toBe(0);
    });
  });

  describe('get80TTBExemption', () => {
    it('should return interest on deposits for senior citizens up to cap', () => {
      expect(get80TTBExemption(30000, 65)).toBe(30000);
      expect(get80TTBExemption(60000, 65)).toBe(MOCK_CONSTANTS.SECTION_80TTB_CAP);
    });
    it('should return 0 for non-senior citizens', () => {
      expect(get80TTBExemption(30000, 50)).toBe(0);
    });
    it('should return 0 for negative interest', () => {
      expect(get80TTBExemption(-1000, 65)).toBe(0);
    });
  });

  describe('getSection24BExemption', () => {
    it('should return interest on housing loan up to cap', () => {
      expect(getSection24BExemption(150000)).toBe(150000);
      expect(getSection24BExemption(250000)).toBe(MOCK_CONSTANTS.SECTION_24B_CAP);
    });
    it('should return 0 for negative interest', () => {
      expect(getSection24BExemption(-50000)).toBe(0);
    });
  });
  ...
  describe('calculateTaxableIncome (Old Regime)', () => {
    ...
    it('should handle zero gross salary', () => {
      const taxableIncome = calculateTaxableIncome(0, exemptions, deductions, age, 'old');
    ...
    it('should handle all zero deductions and exemptions', () => {
      ...
      const taxableIncome = calculateTaxableIncome(grossSalary, zeroExemptions, zeroDeductions, age, 'old');
  ...
  describe('calculateTax', () => {
    it('should calculate tax for old regime (below 60)', () => {
      ...
      expect(calculateTax(taxableIncome, age, regime)).toBe(52500);
    });
    ...
    it('should calculate tax for old regime (60-80)', () => {
      ...
      expect(calculateTax(taxableIncome, age, regime)).toBe(50000);
    });
    ...
    it('should calculate tax for old regime (above 80)', () => {
      ...
      // 5L-7L: 2L * 20% = 40000
      // Total: 40000
      expect(calculateTax(taxableIncome, age, regime)).toBe(40000);
    });
    ...
    it('should calculate tax for new regime', () => {
      ...
      expect(calculateTax(taxableIncome, age, regime)).toBe(60000);
    });

    it('should return 0 tax for income below taxable limit (old regime)', () => {
      expect(calculateTax(200000, 40, 'old')).toBe(0);
    });

    it('should return 0 tax for income below taxable limit (new regime)', () => {
      expect(calculateTax(200000, 40, 'new')).toBe(0);
    });
    ...
    it('should apply rebate 87A for old regime below 5L', () => {
      ...
      expect(calculateTax(taxableIncome, age, regime)).toBe(0);
    });
    ...
    it('should not apply rebate 87A if income is above limit (old regime)', () => {
      ...
      expect(calculateTax(taxableIncome, age, regime)).toBeCloseTo(12500.05);
    });
  ...
  describe('calculateSurcharge', () => {
    ...
    it('should handle marginal relief for income just above 50L', () => {
      ...
      const taxWithoutSurcharge = calculateTax(5000001, 40, 'old'); // Assuming old regime for simplicity
      ...
      const marginalRelief = taxWithSurcharge - (calculateTax(5000000, 40, 'old') + incomeDifference);
      ...
      expect(calculateSurcharge(totalIncome, taxAmount)).toBeGreaterThan(0);
    });
  });
  ...
  describe('calculateCess', () => {
    it('should calculate cess as 4% of (tax + surcharge)', () => {
      ...
      expect(calculateCess(tax, surcharge)).toBe((tax + surcharge) * MOCK_CONSTANTS.CESS_RATE);
    });

    it('should return 0 if tax and surcharge are 0', () => {
      expect(calculateCess(0, 0)).toBe(0);
    });

    it('should handle negative tax/surcharge by treating them as 0', () => {
      expect(calculateCess(-1000, -500)).toBe(0);
    });
  });
  ...
  describe('getRebate87A', () => {
    it('should return full tax amount if taxable income is below limit (old regime)', () => {
      ...
      const age = 40;
      const regime = 'old';
      const taxBeforeRebate = calculateTax(taxableIncome, age, regime); // Should be 7500
      expect(getRebate87A(taxableIncome, taxBeforeRebate, regime)).toBe(taxBeforeRebate);
    });
    ...
    it('should return full tax amount if taxable income is below limit (new regime)', () => {
      ...
      const age = 40;
      const regime = 'new';
      const taxBeforeRebate = calculateTax(taxableIncome, age, regime); // Should be 15000
      expect(getRebate87A(taxableIncome, taxBeforeRebate, regime)).toBe(taxBeforeRebate);
    });
    ...
    it('should return max rebate amount if tax is higher than max rebate (old regime)', () => {
      ...
      const age = 40;
      const regime = 'old';
      const taxBeforeRebate = calculateTax(taxableIncome, age, regime);
      expect(getRebate87A(taxableIncome, taxBeforeRebate, regime)).toBe(taxBeforeRebate);
    });
    ...
    it('should return 0 if taxable income is above limit (old regime)', () => {
      ...
      const regime = 'old';
      const taxBeforeRebate = calculateTax(taxableIncome, age, regime);
      expect(getRebate87A(taxableIncome, taxBeforeRebate, regime)).toBe(0);
    });
  ...
  describe('getTaxRegimeBenefits', () => {
    ...
    it('should calculate benefits for old regime', () => {
      const benefits = getTaxRegimeBenefits(grossSalary, exemptions, deductions, age, 'old');
    ...
    it('should calculate benefits for new regime', () => {
      const benefits = getTaxRegimeBenefits(grossSalary, exemptions, deductions, age, 'new');
  ...
  describe('getTaxRegimeComparison', () => {
    ...
    it('should compare old and new tax regimes and recommend the better one', () => {
      const comparison = getTaxRegimeComparison(grossSalary, exemptions, deductions, age);
    ...
    it('should recommend new regime if it results in lower tax', () => {
      ...
      const comparison = getTaxRegimeComparison(grossSalary, lowExemptions, lowDeductions, age);
